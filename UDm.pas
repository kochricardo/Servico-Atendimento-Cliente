...
type
  ...
  private
    ...
    procedure cancelarItemOcorrenciaRegistrada(cdOcorrencia,nrItem:integer;
      dsMotivoCancelamento:WideString);
    procedure cancelarOcorrenciaRegistrada(cdOcorrencia:integer; dsObservacaoCancelamento: WideString);
  ...
  public
    ...
    procedure execCancelarOcorrenciaRegistrada(cdOcorrencia,nrItem: integer;
...
procedure TDM.execCancelarOcorrenciaRegistrada(cdOcorrencia,nrItem:integer; dsObservacaoCancelamento: WideString);
var
  lTD : TDBXTransaction;
...
begin
  try
    ...
    cancelarItemOcorrenciaRegistrada(cdOcorrencia,nrItem,dsObservacaoCancelamento);

    {cancelar ocorrencia}
    if nrItem = 0 then
    begin
      cancelarOcorrenciaRegistrada(cdOcorrencia,dsObservacaoCancelamento);
...
procedure TDM.cancelarOcorrenciaRegistrada(cdOcorrencia:integer; dsObservacaoCancelamento: WideString);
var
  sqlQuery: TSQLQuery;
  sqlTxt : TStringList;
begin
  ...
  try
    sqlTxt.Clear;
    sqlTxt.Add('UPDATE GAMSAC.DC_SAC_OCORRENCIA SET CD_ST_SOLUCAO_OCORRENCIA = :CD_ST_SOLUCAO_OCORRENCIA, CD_ST_CAUSA_OCORRENCIA = :CD_ST_CAUSA_OCORRENCIA, DS_OCORRENCIA = :DS_OCORRENCIA ');
    sqlTxt.Add('WHERE CD_OCORRENCIA = :CD_OCORRENCIA');
    try
      sqlQuery.Close;
      sqlQuery.SQL.Text:=sqlTxt.Text;
...
procedure TDM.cancelarItemOcorrenciaRegistrada(cdOcorrencia,nrItem:integer; dsMotivoCancelamento:WideString);
var
  sqlQuery: TSQLQuery;
  sqlTxt : TStringList;
begin
